...
// ── Malvec brand palette (R/G/B splat intensities, ~0–10 range) ──────
const MALVEC_COLORS = [
...
function malvecColor() {
    const base = MALVEC_COLORS[Math.floor(Math.random() * MALVEC_COLORS.length)];
